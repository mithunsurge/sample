      ...
      <div className="relative z-10 min-h-screen">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          {[...Array(12)].map((_, i) => (
            <div
              ...
              style={{
                ...
                opacity: 0.6,
                filter: 'blur(0.5px)',
                boxShadow: `0 0 10px ${i % 4 === 0 ? '#007AFF' : i % 4 === 1 ? '#5856D6' : i % 4 === 2 ? '#FF9500' : '#34C759'}`,
              }}
            />
          ))}
          ...
          <div 
            ...
            style={{
              background: `radial-gradient(circle at ${100 - mousePosition.x}% ${100 - mousePosition.y}%, rgba(88, 86, 214, 0.12) 0%, transparent 60%)`,
        ...
        {/* Header */}
        <header className="glass-morphism border-b border-white/15 relative z-20">
        ...
        {/* Hero Section */}
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 relative z-20">
